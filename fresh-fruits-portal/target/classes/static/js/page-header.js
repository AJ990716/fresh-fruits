...
document.writeln("							<form method=\'get\' action=\'#\'>");
document.writeln("								<input type=\'text\' class=\'text\' maxlength=\'200\' name=\'keywords\' id=\'keywords\' autocomplete=\'off\' placeholder=\'请输入您要搜索的商品名称\' />");
document.writeln("								<input type=\'button\' onclick='searchData();' class=\'button iconfont\' value=\'\' />");
